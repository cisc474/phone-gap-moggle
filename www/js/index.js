...
var BoxView = CanvasView.extend({
    ...
    render : function(){
        ...
        var boxx = (pEdge + gutter)*(this.model.id % n);
        var boxy = (pEdge + gutter)*(Math.floor(this.model.id / n));
...
var ScoreView = CanvasView.extend({
    ...
    render :  function(){
        ...
        text.y = 50;
        this.container.addChild(text);
        this.container.x = this.ui.get('width');
        return this;
    }
});
...
var CurrentPathView = CanvasView.extend({
    ...
    render : function(){
        this.container.removeAllChildren();
        console.log("display path please");
        ...
        text.y = -100;
        this.container.addChild(text);
        this.container.y = this.ui.get('height');
        return this;   
    }
});
...
var ui = new UiBrain({edge: 90, gutter: 25, stage: stage, width: $("#gameCanvas").width(), height: $("#gameCanvas").height(), radius: 10});
